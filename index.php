...
if(isset($_SESSION['nome'])) {
    ...
    $nomeUsuario = '<a href="tela_login\login.php">Login</a>'; // Define um link de login como padrão se o usuário não estiver logado
...
<body>
    ...
    <section class="ofertas">
        ...
        ?>
            <div class="produto">
                <form method="GET">
                    <div><img src="<?php echo $produto['destino_img'] ?>" alt="Imagem do Produto"></div>
                    ...
                    <div class="con-like">
                        <input id="btn-<?php echo $produto['id_Produto']; ?>" data-id="<?php echo $produto['id_Produto']; ?>" data-status="<?php echo $produto['favorito']; ?>" class="like" type="checkbox" title="like" <?php if ($produto['favorito'] == 1) {
                                                                                                                                                                                                                                echo "checked";
                                                                                                                                                                                                                            } ?>>
                        <div class="checkmark">
