        ...
        ?>
            <div class="produto">
                <form method="GET">
                    ...
                    <div class="con-like">
                        <input id="btn-<?php echo $produto['id_Produto']; ?>" data-id="<?php echo $produto['id_Produto']; ?>" data-status="<?php echo $produto['favorito']; ?>" class="like" type="checkbox" title="like" <?php if($produto['favorito'] == 1) {echo "checked";} ?>>
                        <div class="checkmark">
