    ...
    <section class="title_home">
        <div class="slogan">
            <h1>Grandes <span>ofertas</span>,</br>
                em um só lugar!</h1>
            <p>Descubra descontos incríveis em um só lugar. Junte-se à nossa comunidade e <span>economize</span> mais!</p>
        </div>
        <div>
    ...
    <footer>
        ...
        <div class="container3">
            <div class="btn-footer">
                <button onclick="location.href='#headid'">Home</button>
                <button onclick="location.href='#ofertas'">Ofertas</button>
                <button onclick="location.href='#container-contact'">Contato</button>
            </div>
