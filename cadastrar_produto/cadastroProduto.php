...
<head>
    ...
    <link rel="preconnect" href="https://fon<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <link rel="stylesheet" href="../cadastrar_produto/styleCadastro.css"> <!-- CSS -->
</head>

<body>
    <div class="part_white">
        <form action="insertProduto.php" method="POST" class="form_login" enctype="multipart/form-data">
